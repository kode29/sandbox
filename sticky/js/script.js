...
if (window.openDatabase){
    // Database: Name, Version, Human Note, Est. Size (bytes)
...
function modifiedString(date){
    return "Sticky Last Modified: "+date.getFullYear() + " - " + (date.getMonth() + 1) + " - " + date.getDay() + " @ " + date.getHours() + ":"+ date.getMinutes() + ":"+ date.getSeconds();
}
